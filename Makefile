...
obj-m += zeth.o
zeth-objs := xdma-core.o xdma-sgm.o xdma-ioctl.o xdma-bit.o xdma_eth.o xdma_ethapi.o xbasic_types.o
...
CFLAGS_xdma_eth.o := -DDEBUG -DX86_64 $(XILINXINCLUDE)
CFLAGS_xdma_ethapi.o := -DDEBUG -DX86_64 $(XILINXINCLUDE)
CFLAGS_xbasic_types.o := -DDEBUG -DX86_64 $(XILINXINCLUDE)
